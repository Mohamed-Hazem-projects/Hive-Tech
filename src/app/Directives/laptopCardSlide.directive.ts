...
import { LaptopCardSliderComponent } from '../content/laptops/laptop-card-slider/laptop-card-slider.component';

@Directive({
  selector: '[LaptopCardSlide]',
  standalone: true
})
export class LaptopCardSlideDirective implements AfterViewInit {

  constructor(private element: LaptopCardSliderComponent) { }
  startTouch: number = 0;
  endTouch: number = 0;
  startClick: number = 0;
  endClick: number = 0;
