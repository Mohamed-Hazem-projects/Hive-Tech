...
import { LaptopsLevelsComponent } from '../content/laptops/laptops-levels/laptops-levels.component';
@Directive({
  selector: '[levelsSlide]',
  standalone: true
})
export class LaptopLevelSlideDirective {

  constructor(private element: LaptopsLevelsComponent) { }
  startTouch: number = 0;
  endTouch: number = 0;
  startClick: number = 0;
  endClick: number = 0;
